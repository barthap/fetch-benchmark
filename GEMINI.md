...
## 1. Project Overview
A React Native / Expo application designed to benchmark different HTTP client implementations (Standard Fetch, Axios, XMLHttpRequest, Expo FileSystem) when handling large JSON/File responses.
